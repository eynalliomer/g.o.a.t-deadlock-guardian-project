...
| 3 | Kaynak İlişkileri | Allocation/request tabloları, çok örnekli kaynaklar, olay kaydı, senaryoların dosyadan yüklenmesi | Senaryo dosyasıyla çalışan sistem, durum tablosu | |
| 4 | Deadlock Tespiti | RAG + DFS ile döngü arama, çok örnekli kaynaklar için detection algoritması, raporlama | Tespit modülü ve birim testleri | |
| 5 | Görselleştirme | Graf çizimi, tutma/bekleme kenarları, döngünün vurgulanması | RAG ekranı | |
